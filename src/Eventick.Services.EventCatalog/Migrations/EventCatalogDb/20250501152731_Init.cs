...
namespace Eventick.Services.EventCatalog.Migrations.EventCatalogDb
{
    /// <inheritdoc />
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("4118670c-60a4-4455-accb-866d330792ba"), "National School of Drama", new Guid("1a58c498-f6fe-4a41-b1ec-bd2f33b1d2b2"), new DateTime(2025, 9, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "Girish Karnad's classic play about the 14th century Sultan Muhammad bin Tughlaq. Hindi adaptation.", "/img/tughlaq-play.jpg", "Tughlaq: The Political Drama", 2500 },
                    ...
                    { new Guid("b4f2acd2-a883-41c3-b179-2eee0ecd232d"), "Ranga Shankara", new Guid("1a58c498-f6fe-4a41-b1ec-bd2f33b1d2b2"), new DateTime(2025, 11, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "Girish Karnad's landmark play exploring identity through Indian folk theatre traditions.", "/img/hayavadana.jpg", "Hayavadana: Experimental Theatre", 3000 },
                    ...
                    { new Guid("f55c5205-3123-49d7-b3c3-4f7d0601abb8"), "Ratan Thiyam's Chorus Repertory", new Guid("1a58c498-f6fe-4a41-b1ec-bd2f33b1d2b2"), new DateTime(2026, 3, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Powerful rendition of Dharamvir Bharati's Partition-era play. Multiple Sahitya Akademi award winner.", "/img/andha-yug.jpg", "Andha Yug: The Blind Age", 1800 }
                });
