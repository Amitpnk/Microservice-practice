...
namespace Eventick.Services.EventtCatalog.DbContexts;
...
public class EventCatalogDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Event>().HasData(new Event
        {
            ...
            Price = 65,
            Artist = "John Egbert",
            Date = new DateTime(2025, 10, 1), // Static date
        ...
        modelBuilder.Entity<Event>().HasData(new Event
        {
            ...
            Date = new DateTime(2026, 1, 1), // Static date
        ...
        modelBuilder.Entity<Event>().HasData(new Event
        {
            ...
            Price = 135,
            Artist = "Nick Sailor",
            Date = new DateTime(2025, 12, 1), // Static date
